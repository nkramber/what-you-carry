...
public static class Invariant
{
    ...
    /// <param name="fields">The context fields of the report. The helper adds the call site to them.</param>
        ...
        [CallerMemberName] string callerMember = "")
    {
        ...
        fields.Add("assertFile", callerFile);
        fields.Add("assertLine", callerLine);
        fields.Add("assertMember", callerMember);
        logger.Write(context, LogLevel.Error, message, fields);
