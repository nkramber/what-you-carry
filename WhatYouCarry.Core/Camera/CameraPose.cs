...
/// boom starts and where a shot starts (D-242, D-268).
/// </summary>
/// <remarks>
...
/// </remarks>
public readonly record struct CameraPose(Vector3 Position, Vector3 Forward, Vector3 Right, Vector3 Up, Vector3 Shoulder);
