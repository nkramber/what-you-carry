...
- Review round 2 through `make codex-review PR=102`. The correction changes `docs/reviews/` alone, so the effective head stays `69f5308`, and CI and the gitar pass of that head stand.
- Then the merge summary in Q/A form (D-552).
...
Run review round 2 with `make codex-review PR=102`. On approval, give the merge summary in Q/A form and ask the owner to confirm the merge.
