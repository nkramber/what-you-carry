...
The 08:07 UTC night of 2026-09-11 never fired (F-95). The row of the first scheduled night follows when it runs, at 15:21 UTC (D-283, D-286). The table is complete then. The longest night so far took 68 minutes against the six-hour bound.
...
- OQ-155 (D-286): the schedule test at 15:21 UTC, with the workflow turned off and on. The night workflow and Gate 1.
