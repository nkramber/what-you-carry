...
- The water probe of the body reads the column under the feet: the feet cell holds water, or the body is in the air over water with air alone between. The probe holds through the jump, because a jump that loses the quarter gravity when the feet leave the cell ends below one block.
