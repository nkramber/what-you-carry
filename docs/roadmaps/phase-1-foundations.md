...
The 08:07 UTC night of 2026-09-11 never fired (F-95). The row of the first scheduled night follows when it runs, at 17:21 UTC (D-283, D-286). The table is complete then. The longest night so far took 68 minutes against the six-hour bound.
...
22. ✅ M-1 table complete 2026-09-10 (D-276, D-277). M-2 table: seven nights, six by hand on 2026-09-10 and the first scheduled night (D-283).
23. **← GATE 1 (foundation).** Every exit test in this file passes. The bit-identity job, `dotnet test`, and the night sweep are green. The owner signs the gate in `docs/decisions.md`. Gate 1 signs after the first scheduled night passes on its own (D-283).
