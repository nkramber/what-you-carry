...
| D-178 | 2026-09-07 | Reference check | The PR-2 checker adds a reference check. It reads the Effect column of this file. It fails on any file outside this file that cites a revised decision as a current answer. | Resolves review finding P2-1 on PR #1. Binds PR-2. |
