...
Implement the visible per-floor timer with lengths in data (D-44, D-46, D-407). Implement the hunter as one entity with a speed curve that grows until escape is impossible, and the escalation spawner (D-45, D-408 to D-410). A death carries its cause (D-411). The timer pauses at the stairwell and runs in boss fights (D-140). Add the timer-tester bot policy (D-149).
