...
- [ ] The STE checker passes (G-14). Absent until PR-2 creates it (D-148). The author applied the `ste-writing` checklist by hand.
...
- [ ] Every check that does not exist yet is named above with the PR that creates it (D-148, G-19).
